...
const BrandInfo = () => {
  return (
    ...
    <div className="contents-action">
      ...
      <button type="button" className="btn_action" id="eye"><img  src={eye} alt="eye" /></button>
      <button type="button" className="btn_action" id="heart"><img  src={heart} alt="heart" /></button>
      <button type="button" className="btn_action" id="save"><img  src={save} alt="save"/></button>
    </div>
    </section>
